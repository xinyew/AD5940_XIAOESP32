...
/* Application related parameters */ 
  ...
  float EquilibriumTime; /**< The time to hold the voltage at start potential before starting the measurement. Unit is ms. */
  ...
  uint8_t   ADCSinc2Osr;          /**< SINC2 OSR. Used for Notch filter. */
  /* Digital related */
